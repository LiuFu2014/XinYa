...
namespace XinYaBarCodePrinter
{
    public partial class frm_Login : Form
    {
        ...
        //int secID =Convert.ToInt32(System.Configuration.ConfigurationSettings.AppSettings["SecondWorkStationID"]);
        ...
        private void btnYes_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //    try
                //    {
                //        TB_User user = db.TB_User.First(p => p.UserID == txt_UserID.Text && p.Password == txt_Password.Text);
                //        //检查是否被禁用
                //        if (user.IsUse != true)
                //        {
