namespace XinYaWorkTimeHelper
{
    partial class frm_Helper
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textBox1.Size = new System.Drawing.Size(422, 380);
            this.textBox1.TabIndex = 0;
            this.textBox1.Text = "    1.本程序只能绑定今日的工作记录，需要绑定其他日期的工作记录请联系管理员。\r\n    2.本程序在绑定前会对员工工号进行一次检测，如果该工号在系统中并不存" +
                "在，则会中止处理，不进行绑定。需要通过员工工号验证后才能继续。\r\n    3.如果重复绑定今日的工作记录，则新绑定的信息会覆盖旧的绑定信息。 ";
            // 
            // label1
            // 
